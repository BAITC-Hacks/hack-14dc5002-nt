...
Ветка: **Bakytzhan**. Основные этапы: `d9813f6` — движок и расчёт,
...
этапы зависят друг от друга. Ветка уже включает основу Semba `924d8a1`.

Сообщение для передачи вручную:

> Сервер готов в Bakytzhan: organizer-v1, реальный simulate, отмена и обязательная мера,
